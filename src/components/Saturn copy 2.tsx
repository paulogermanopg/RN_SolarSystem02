...
const Saturn = () => {
  ...
  return (
    <Canvas style={{ width, height }}>
      <Group>
        {/* Anel de trás (parte superior arredondada, inferior reta) */}
        <Path
          path={useDerivedValue(
            () => `
              M ${width / 2 - 110} ${height / 2}
              A 110 40 0 1 1 ${width / 2 + 110} ${height / 2}
              L ${width / 2 + 110} ${height / 2 + 2}
              A 110 40 0 1 0 ${width / 2 - 110} ${height / 2 + 2}
              Z
            `,
            [animatedTilt]
          )}
        ...
        {/* Anel da frente (parte superior reta, inferior arredondada) */}
        <Path
          path={useDerivedValue(
            () => `
              M ${width / 2 - 110} ${height / 2 - 2}
              L ${width / 2 + 110} ${height / 2 - 2}
              A 110 40 0 1 1 ${width / 2 - 110} ${height / 2 - 2}
              Z
            `,
            [animatedTilt]
          )}
