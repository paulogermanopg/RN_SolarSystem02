        ...
        <Path
          path={useDerivedValue(
            () => `
              ...
              A 110 40 0 1 1 ${width / 2 + 110} ${height / 2 + animatedTilt.value}
              L ${width / 2 + 95} ${height / 2 + 15 + animatedTilt.value}
              A 95 30 0 1 0 ${width / 2 - 95} ${height / 2 + 15 + animatedTilt.value}
              Z
            `,
            [animatedTilt]
          )}
        ...
        <Path
          path={useDerivedValue(
            () => `
              ...
              L ${width / 2 - 95} ${height / 2 + 5 + animatedTilt.value}
              A 95 30 0 1 0 ${width / 2 + 95} ${height / 2 + 5 + animatedTilt.value}
              Z
            `,
            [animatedTilt]
          )}
